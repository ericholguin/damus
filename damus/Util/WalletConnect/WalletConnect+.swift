...
extension WalletConnect {
    ...
    /// - Returns: The Nostr Event that was sent to the network, representing the request that was made
    @discardableResult
    static func request_balance_information(url: WalletConnectURL, pool: RelayPool, post: PostBox, delay: TimeInterval? = 5.0, on_flush: OnFlush? = nil) -> NostrEvent? {
    ...
    /// - Returns: The Nostr Event that was sent to the network, representing the request that was made
    @discardableResult
    static func request_transaction_list(url: WalletConnectURL, pool: RelayPool, post: PostBox, delay: TimeInterval? = 5.0, on_flush: OnFlush? = nil) -> NostrEvent? {
